                                ...
                                if tryx == var_sect[0]:
                                    if forA == var_sect[0]:
                                        if fivA == var_sect[0]:
                                            ...
                                            print("\033[1;32m result\033[0m --->: " , funcx_0)
                                            sys.exit(0)
                                        elif var_sect[1] == fivA :
                                            print("my calculator : ", rawx , xt,  rawy , z, rawc )
                                            funcx_1 =eval('rawx + rawy - rawc '+'\n' )
                                            print("\033[1;32m result\033[0m --->: " , funcx_1)
                                            sys.exit(0)
                                        elif fivA == var_sect[2]:
                                            print("my calculator : ", rawx , xt,  rawy , z, rawc )
                                            funcx_2 =eval('rawx + rawy  / rawc '+'\n' )
                                            print("\033[1;32m result\033[0m --->: " , funcx_2)
                                            sys.exit(0)
                                        elif fivA == var_sect[3]:
                                            print("my calculator : ", rawx , xt,  rawy , z, rawc )
                                            funcx_3 =eval('rawx + rawy  * rawc '+'\n' )
                                            print("\033[1;32m result\033[0m --->: " , funcx_3)
                                            sys.exit(0)
                                        elif fivA == var_sect[4]:
                                            print("my calculator : ", rawx , xt,  rawy , z, rawc )
                                            funcx_4 =eval('rawx + rawy  % rawc '+'\n' )
                                            print("\033[1;32m result\033[0m --->: " , funcx_4)
                                            sys.exit(0)
                                        elif fivA == var_sect[5]:
                                            print("my calculator : ", rawx , xt,  rawy , z, rawc )
                                            funcx_5 =eval('rawx + rawy  // rawc '+'\n' )
                                            print("\033[1;32m result\033[0m --->: " , funcx_5)
                                            sys.exit(0)
                                        elif fivA == var_sect[6]:
                                            def ExpMwob( nam , nem ):
                                                print("my calculator : ", rawx , xt,  rawy , z, rawc )
                                                powcx_0 = math.pow(nam , nem ) 
                                                funcx_6 = eval('powcx_0 + rawc'+'\n')
                                            ...
                                            #     print("now _ command error> \033[1;33m ERR0R \033[0m " )
                                            sys.exit(1)
                                    elif forA == var_sect[1]:
                                    elif forA == var_sect[2]:
                                    elif forA == var_sect[3]:
                                    elif forA == var_sect[4]:
                                    elif forA == var_sect[5]:
                                    elif forA == var_sect[6]:
                                    elif forA == var_sect[7]:
                                    else:
                                        sys.exit(0)
                                elif tryx == var_sect[1]:
                                elif tryx == var_sect[2]:
                                elif tryx == var_sect[3]:
                                elif tryx == var_sect[4]:
                                elif tryx == var_sect[5]:
                                elif tryx == var_sect[6]:
                                elif tryx == var_sect[7]:
                                elif != var_sect[0:10]:
                                    sys.exit(1)
                                                ...
                                                if fiv_A == var_sect[0]:
                                                    ...
                                                    if xt == var_sect[1]:
                                                        ...
                                                        if z == var_sect[0]:
                                                            ...
                                                            sys.exit(1)
                                                elif fiv_A == var_sect[1]:
                                                    pass
                                                elif fiv_A == var_sect[2]:
                                                    pass
                                                elif fiv_A == var_sect[3]:
                                                    pass
                                                elif fiv_A == var_sect[4]:
                                                    pass
                                                elif fiv_A == var_sect[5]:
                                                    pass
                                                elif fiv_A == var_sect[6]:
                                                    pass
                                                elif fiv_A == var_sect[7]:
                                                    pass
                                            elif forA == var_sect[1]:
                                            elif forA == var_sect[2]:
                                            elif forA == var_sect[3]:
